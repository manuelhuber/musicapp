 ...
 * [FingerControl.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FingerControl.newInstance] factory method to
...
class FingerControl : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FingerControl.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): FingerControl {
            val fragment = FingerControl()
            val args = Bundle()
